...
5. Удали протестированное из `future/` (без дублей). Запиши отчёт в `knowledge/past/hxx_slug.md` и строку в INDEX (шаблон — ниже и в [`past/README.md`](knowledge/past/README.md)). В корне `past/` держи ~10 полных отчётов; старше — сверни в [`past/lines/`](knowledge/past/lines/) (см. README).
